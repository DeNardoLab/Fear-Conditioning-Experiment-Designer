...
![Example schematic showing Arduino connections for controlling a shocker, houselight, and second Arduino for customizable laser control](https://github.com/DeNardoLab/Fear-Conditioning-Experiment-Designer/blob/main/FCXD_schematic_v2.tif)
# USAGE
