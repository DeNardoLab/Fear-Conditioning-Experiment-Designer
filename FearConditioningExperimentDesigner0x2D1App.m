classdef FearConditioningExperimentDesigner0x2D1App < handle
    %
    % Usage:
    %     app.FearConditioningExperimentDesigner0x2D1App
    ...
    properties (Constant)
        AppPathBase = {'/FearConditioningExperimentDesigner - 1'};
        AppClass = 'FearConditioningExperimentDesigner0x2D1App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = FearConditioningExperimentDesigner0x2D1App()
        ...
        function startApp(obj)
            ...
            mlock;
            FearConditioningExperimentDesigner0x2D1App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'FC_Design')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong FC_Design
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'FC_Design').getString, ...
            ...
            if nargout(@FC_Design) == 0
                eval('FC_Design');
            else
                obj.AppHandle = eval('FC_Design');
            end
